...
<link rel=stylesheet href="<c:url value='/css/my_study_list.css' />" type="text/css">
    ...
    <div class="page">
      ...
      <div class="tab-container">
        <div class="tabs on" onclick="openTab('Tab1')">
           <div> <img src="<c:url value='/images/leader.svg' />" id="tabIcon"></div>
           <div>팀장</div> 
        </div>
        <div class="tabs" onclick="openTab('Tab2')">
            <div> <img src="<c:url value='/images/follower.svg' />" id="tabIcon"></div>
            <div>팀원</div> 
        </div>
    </div>
